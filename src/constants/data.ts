export const EVENT_DATA = [
  // Tech-Spardha Events
  {
    ...
    entry_fees: 75,
    prize_money: { first: 300, second: 200, third: 150 },
    event_requirement: "No prior setup needed.",
    event_guidelines: [
  ...
  },
  {
    ...
    event_requirement: "Bring your own robot car.",
    event_guidelines: [
      "Robots must be autonomous or remote-controlled",
      "No physical interference allowed",
    ],
  },
