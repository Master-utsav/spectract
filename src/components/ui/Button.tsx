  ...
  return (
    <div className={cn(className, isRight ? "relative rotate-y-180" : "")}>
      {isHovered && (
        ...
        >
          <Image
            src={`/img/${btnName === "Fashionista Ada" ? "fashionista_ada_flyer.jpg" : btnName === "Kalaa Utsav" ? "kalaa_utsav_flyer.jpg" : btnName === "Tech Spardha" ? "tech_spardha_flyer.jpg" : btnName === "E-Sports" ? "e_sports_flyer.jpg" : btnName === "Thrill Area" ? "e_sports_flyer.jpg" : "e_sports_flyer.jpg"}`}
            alt="Floating Image"
            width={150}
            height={200}
            className={cn(
